...
def driver():
    ...
    # Используем Chrome вместо Firefox (более стабильно)
    options = Options()
...
class TestShop:
    ...
    def test_purchase_items(self, driver):
        ...
        with allure.step("Заполнить форму оформления заказа"):
            ...
            checkout_page.fill_first_name("Марина")
            checkout_page.fill_last_name("Гулевич")
            checkout_page.fill_postal_code("655603")
        ...
        with allure.step("Проверить итоговую сумму"):
            ...
            # Используем округление для избежания проблем с float
