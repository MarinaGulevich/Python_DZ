...
def test_pay_form():
    ...
    driver.find_element(By.CSS_SELECTOR, "#first-name").send_keys("Марина")
    driver.find_element(By.CSS_SELECTOR, "#last-name").send_keys("Гулевич")
    driver.find_element(By.CSS_SELECTOR, "#postal-code").send_keys("655603")
    ...
    assert "$58.29" in total.text, \
        f"Ожидал рез-ат '$58.29',но получили {total.text}"
